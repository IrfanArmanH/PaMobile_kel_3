...
class _MusicScreenState extends State<MusicScreen> {
  ...
  // late final List<String> songUrls;
  ...
  void initState() {
    ...
    // Ganti "songs" dengan nama koleksi di Firebase Anda
    Future<void> getSongUrlsFromFirebase() async {
  ...
  void playNextSong() {
    // Ganti currentIndex untuk memainkan lagu selanjutnya
    ...
    setState(() {
      _controller.dispose();
      setAudio(); // Setel ulang audio player dengan lagu berikutnya
    });
  }
